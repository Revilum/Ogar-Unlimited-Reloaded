Thanks to [jerk](https://github.com/jerk) for his updated repository. You can acces a client under [this](http://ogar.revilum.com/) webiste. If you encounter any issues with the server, feel free to contact me: [on reddit](https://www.reddit.com/user/Revilum1) or on Discord: Revilum#9569. In the future I might not be interesting to support this repository but I'll be happy to provide you with all the files you need to set it up yourself.
